...
MoveResult make_move(const char position[2], const char mines[9][9], char revealed[9][9]);
bool find_safe_move(const char revealed[9][9], char move[MAX_LENGTH]);
void convert_position_to_row_col(const char position[3], int &row, int &col);
